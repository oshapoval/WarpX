...
void
PhysicalParticleContainer::Evolve1 (ablastr::fields::MultiFabRegister& fields,
                                   int lev,
                                   const std::string& current_fp_string,
                                   Real /*t*/, Real dt, DtType a_dt_type, bool skip_deposition,
                                   PushType push_type)
{
    ...
    WARPX_PROFILE("PhysicalParticleContainer::Evolve1()");
    WARPX_PROFILE_VAR_NS("PhysicalParticleContainer::Evolve1::GatherAndPush", blp_fg);
...
void
PhysicalParticleContainer::Evolve2 (ablastr::fields::MultiFabRegister& fields,
                                   int lev,
                                   const std::string& current_fp_string,
                                   Real /*t*/, Real dt, DtType a_dt_type, bool skip_deposition,
                                   PushType push_type)
{
    ...
    WARPX_PROFILE("PhysicalParticleContainer::Evolve2()");
    WARPX_PROFILE_VAR_NS("PhysicalParticleContainer::Evolve2::GatherAndPush", blp_fg);
