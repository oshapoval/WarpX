                                ...
                                PushType push_type)
{
    ...
    for (auto& pc : allcontainers) {
        pc->Evolve1(fields, lev, current_fp_string, t, dt, a_dt_type, skip_deposition, push_type);
    }
}
                                ...
                                PushType push_type)
{
    ...
    for (auto& pc : allcontainers) {
        pc->Evolve2(fields, lev, current_fp_string, t, dt, a_dt_type, skip_deposition, push_type);
    }
}
